   ...
   return (
      <>
         <Navbar expand="lg" className="bg-nav">
            <Container fluid>
               <Navbar.Brand><h2 className='bg-nav-btn'>RentEase</h2></Navbar.Brand>
               ...
               <Navbar.Collapse id="navbarScroll">
                  ...
                  <Nav>
                     <Link className='bg-nav-btn' to={'/'}>Home</Link>
                     <Link className='bg-nav-btn' to={'/register'}>Register</Link>
                     <Link className='bg-nav-btn' to={'/login'}>Login</Link>
                  </Nav>
